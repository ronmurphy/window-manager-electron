...
class FileManager {
    ...
    <button onclick="fileManager.setView('gallery')" class="view-button" title="Gallery View">
    ...
    async updateFileList(files) {
        ...
        // If in gallery view, use gallery layout
        if (this.currentView === 'gallery') {
            // First create the container structure
            fileList.innerHTML = `
                <div class="gallery-container">
                    <div class="gallery-top">
                        <div class="gallery-images" data-section="Images"></div>
                        <div class="gallery-files" data-section="Files"></div>
                    </div>
                    <div class="gallery-folders" data-section="Folders"></div>
                </div>
            `;
            ...
            // Process each file into the appropriate container
            files.forEach(file => {
                const itemHtml = `
                ...
                if (file.isDirectory) {
                    galleryFolders.insertAdjacentHTML('beforeend', itemHtml);
                } else if (this.isImageFile(file.path)) {
                    galleryImages.insertAdjacentHTML('beforeend', imageItemHtml);
                } else {
                    galleryFiles.insertAdjacentHTML('beforeend', itemHtml);
                }
            });
            ...
            // Original list/grid view behavior
